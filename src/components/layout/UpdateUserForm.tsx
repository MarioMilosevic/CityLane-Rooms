...
import { updateUserDataFormValues, updateUserDataSchema } from "src/validation/updateUserData";
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <ButtonWrapper justify="end">
        ...
        <PrimaryActionButton text="Update account" color="yellow" type="submit"/>
      </ButtonWrapper>
    </form>
  );
}
